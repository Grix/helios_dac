This is the shared library extension of the Helios DAC SDK, used to produce a library file like .dll, .so or .dylib. It has compatibility functions with the EzAudDac and OLSC standards. 
